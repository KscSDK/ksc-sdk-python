...
from kscore import ScalarTypes
from kscore.hooks import first_non_none_response
from kscore.compat import json, set_socket_timeout, XMLParseError
from kscore.exceptions import IncompleteReadError
...
class StreamingBody(object):
    ...
    def set_socket_timeout(self, timeout):
        ...
        try:
            ...
            # in py2 and py3.  So this code has been pushed to kscore.compat.
