...
import kscore.compat
from kscore.compat import total_seconds
from kscore.exceptions import UnknownCredentialError
from kscore.exceptions import PartialCredentialsError
from kscore.exceptions import ConfigNotFound
from kscore.exceptions import InvalidConfigError
from kscore.exceptions import RefreshWithMFAUnsupportedError
from kscore.utils import InstanceMetadataFetcher, parse_key_val_file
...
class Credentials(object):
    ...
    def _normalize(self):
        ...
        self.access_key = kscore.compat.ensure_unicode(self.access_key)
        self.secret_key = kscore.compat.ensure_unicode(self.secret_key)
...
class RefreshableCredentials(Credentials):
    ...
    def _normalize(self):
        self._access_key = kscore.compat.ensure_unicode(self._access_key)
        self._secret_key = kscore.compat.ensure_unicode(self._secret_key)
...
class ConfigProvider(CredentialProvider):
    ...
    def __init__(self, config_filename, profile_name, config_parser=None):
        ...
        if config_parser is None:
            config_parser = kscore.configloader.load_config
...
class AssumeRoleProvider(CredentialProvider):
    ...
    def __init__(self, load_config, client_creator, cache, profile_name,
        ...
        :param client_creator: A factory function that will create
            ...
            ``kscore.session.Session.create_client``.
    ...
    def _load_creds_via_assume_role(self):
        ...
        if creds is not None:
            ...
            # We get the Credential used by kscore as well
