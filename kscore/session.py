...
"""
This module contains the main interface to the kscore package, the
Session object.
"""
...
from kscore import handlers
from kscore.hooks import HierarchicalEmitter, first_non_none_response
from kscore.loaders import create_loader
from kscore.parsers import ResponseParserFactory
from kscore.regions import EndpointResolver
from kscore.model import ServiceModel
from kscore import paginate
from kscore import waiter
from kscore import retryhandler, translate


class Session(object):
    """
    The Session object collects together useful functionality
    from `kscore` as well as important data such as configuration
    ...
    #: ``get_config_variable`` method of the :class:`kscore.session.Session`
    #: class.
        ...
        **entire** config file.
        ...
        if self._config is None:
            try:
                ...
                self._config = kscore.configloader.load_config(config_file)
            ...
            try:
                ...
                cred_profiles = kscore.configloader.raw_config_parse(cred_file)
    ...
    def set_default_client_config(self, client_config):
        ...
        :type client_config: kscore.client.Config
    ...
    def set_credentials(self, access_key, secret_key, token=None):
        ...
        prefer to use kscore without a config file, environment variables,
    ...
    def get_credentials(self):
        """
        Return the :class:`kscore.credential.Credential` object
    ...
    def set_debug_logger(self, logger_name='kscore'):
        """
    ...
    def set_file_logger(self, log_level, path, logger_name='kscore'):
        """
    ...
    def create_client(self, service_name, region_name=None, api_version=None,
        ...
        :type api_version: string
        :param api_version: The API version to use.  By default, kscore will
        ...
        :param verify: Whether or not to verify SSL certificates.
            ...
            * path/to/cert/bundle.pem - A filename of the CA cert bundle to
              ...
              different CA cert bundle than the one used by kscore.

        :type endpoint_url: string
        :param endpoint_url: The complete URL to use for the constructed
            client.  Normally, kscore will automatically construct the
        ...
        :rtype: kscore.client.BaseClient
        :return: A kscore client instance
