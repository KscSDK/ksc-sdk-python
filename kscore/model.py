...
from kscore.utils import CachedProperty, instance_cache
...
class Shape(object):
    ...
    def __init__(self, shape_name, shape_model, shape_resolver=None):
        ...
        :type shape_resolver: kscore.model.ShapeResolver
...
class ServiceModel(object):
    ...
    def __init__(self, service_description, service_name=None):
        ...
        :param service_description: The service description model.  This value
            is obtained from a kscore.loader.Loader, or from directly loading
            the file yourself::
        ...
        :param service_name: The name of the service.  Normally this is
            ...
            This is done in a few places in kscore (ses instead of email,
...
class OperationModel(object):
    def __init__(self, operation_model, service_model, name=None):
        ...
        :type service_model: kscore.model.ServiceModel
...
class DenormalizedStructureBuilder(object):
    ...
    Example usage::
        ...
        # ``shape`` is now an instance of kscore.model.StructureShape
    ...
    def build_model(self):
        ...
        :rtype: kscore.model.StructureShape
